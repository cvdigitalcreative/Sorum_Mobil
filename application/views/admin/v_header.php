...
<head>
  ...
  <link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/admin/img/logo/logop.png'?>">
  <!-- Bootstrap 3.3.6 -->
...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini">Srm</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Sorum</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                ...
                ?>
                  <li><!-- start message -->
                    <a href="<?php echo base_url().'Admin/Inbox'?>">
                      <div class="pull-left">
                        <img src="<?php echo base_url().'assets/admin/images/user_blank.png'?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        <?php echo $inbox_nama;?>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url().'assets/admin/images/'.$c['pengguna_photo'];?>" class="user-image" alt="">
              <span class="hidden-xs"><?php echo $c['pengguna_nama'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url().'assets/admin/images/'.$c['pengguna_photo'];?>" class="img-circle" alt="">
